...
#     password = forms.CharField(max_length=10,widget=forms.PasswordInput(render_value=False))
#
#     def clean(self):
...
#         return authenticate(email=self.email, password=self.password)
#
#
#
...
#     password = forms.CharField(max_length=10, widget=forms.PasswordInput(render_value=False), required=True)
#
#     def clean(self):
#         email = self.cleaned_data['email']
